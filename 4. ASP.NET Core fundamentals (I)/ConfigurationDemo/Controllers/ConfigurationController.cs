...
[ApiController]
[Route("[controller]")]
public class ConfigurationDemoController(IConfiguration configuration) : ControllerBase
{
    ...
    //  using option pattern/ConfigurationBinder.Bind() method
    [HttpGet]
    ...
    //  using option pattern/ConfigurationBinder.Get<TOption>() method
    [HttpGet]
    ...
    //  USING option pattern/IOptions<TOption> interface:
    // -> after registering the DatabaseOption class in the program file, we can use DI to inject
    ...
    public ActionResult GetDatabaseConfigurationWithIOptionsSnapshot([FromServices]
    ...
    //  Other/IOptionsMonitor<TOption> interface
    [HttpGet]
    [Route("database-configuration-with-ioptions-monitor")]
    public ActionResult GetDatabaseConfigurationWithIOptionsMonitor([FromServices]
